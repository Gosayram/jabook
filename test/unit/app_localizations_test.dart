...
void main() {
  ...
  group('AppLocalizations', () {
    ...
    test('should load English translations correctly', () async {
      ...
      expect(localizations.searchPlaceholder,
          equals('Enter title, author, or keywords'));
      ...
      expect(localizations.logsExportedSuccessfully,
          equals('Logs exported successfully'));
    ...
    test('should load Russian translations correctly', () async {
      ...
      expect(localizations.searchPlaceholder,
          equals('Введите название, автора или ключевые слова'));
      expect(
          localizations.failedToSearch, equals('Не удалось выполнить поиск'));
      ...
      expect(localizations.logsExportedSuccessfully,
          equals('Логи успешно экспортированы'));
      expect(localizations.failedToExportLogs,
          equals('Не удалось экспортировать логи'));
    });
