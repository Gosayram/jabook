...
void main() {
  group('ResumeRestoredDownloadUseCase', () {
    late TestDownloadsRepository testRepository;
    late ResumeRestoredDownloadUseCase useCase;

    setUp(() {
      testRepository = TestDownloadsRepository();
      useCase = ResumeRestoredDownloadUseCase(testRepository);
    });
    ...
    test('should resume restored download', () async {
      // Arrange
      ...
      expect(resumedDownload.isRestored, isFalse);
    });
