...
void main() {
  group('PlayUseCase', () {
    ...
    late PlayUseCase useCase;

    setUp(() {
      testRepository = TestPlayerRepository();
      useCase = PlayUseCase(testRepository);
    });
    ...
    test('should play when called', () async {
      // Arrange
    ...
    test('should throw exception when repository fails', () async {
      // Arrange
      testRepository.shouldFailPlay = true;
    ...
    test('should resume paused playback', () async {
      // Arrange
      testRepository.setState(const PlayerState(
        isPlaying: false,
      ...
      final state = await testRepository.getState();
      expect(state.isPlaying, isTrue);
      expect(state.currentPosition, equals(50000));
    });
  });
}
