...
/**
 * P-91: Time and speed formatting utilities extracted from PlayerScreen.
 */
internal object PlayerTimeFormatter {
    ...
    /**
     * Format playback speed for display (e.g., "1.5x", "2x").
     */
    fun formatPlaybackSpeedLabel(playbackSpeed: Float): String {
        val formattedSpeed =
