...
# Kotlin serialization - R8 Full Mode Compatible Rules
-keepattributes *Annotation*, InnerClasses
-dontnote kotlinx.serialization.AnnotationsKt

# CRITICAL FOR R8 FULL MODE: Explicitly keep ALL @Serializable classes and their members
# R8 Full Mode (AGP 8.0+) does NOT implicitly keep constructors, so we must be explicit
...
# Keep Companion objects (needed for serializer() method lookup)
-keepclassmembers class ** {
    *** Companion;
}

# Keep serializer() method on companion objects
-keepclasseswithmembers class ** {
    kotlinx.serialization.KSerializer serializer(...);
}

# EXPLICIT: Keep all fields in @Serializable classes (prevent field renaming)
-keepclassmembers @kotlinx.serialization.Serializable class ** {
    <fields>;
}

# EXPLICIT: Keep ALL constructors in @Serializable classes
# This is CRITICAL for R8 Full Mode - default constructors are NOT implicitly kept
-keepclassmembers @kotlinx.serialization.Serializable class ** {
    <init>(...);
}
...
# ============================================================================
# Re-enabled: With proper wildcard -keep rules for @Serializable, these should work
