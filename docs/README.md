...
### [Makefile: сборка, проверка и запуск](10-makefile-workflows.md) ⚙️

Практический справочник по локальной разработке, beta/prod-сборкам, проверкам качества, тестам и запуску на Android-устройстве.
