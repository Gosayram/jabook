...
/// Use case for resuming a paused torrent download.
class ResumeTorrentUseCase {
  /// Creates a new ResumeTorrentUseCase instance.
  ResumeTorrentUseCase(this._repository);

  final TorrentRepository _repository;

  /// Executes the resume torrent use case.
  ///
  /// The [taskId] parameter is the unique identifier for the task.
  ///
  /// Throws [Exception] if resuming fails.
  Future<void> call(String taskId) => _repository.resumeDownload(taskId);
}
