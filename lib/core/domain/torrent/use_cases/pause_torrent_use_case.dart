...
/// Use case for pausing a torrent download.
class PauseTorrentUseCase {
  /// Creates a new PauseTorrentUseCase instance.
  PauseTorrentUseCase(this._repository);

  final TorrentRepository _repository;

  /// Executes the pause torrent use case.
  ///
  /// The [taskId] parameter is the unique identifier for the task.
  ///
  /// Throws [Exception] if pausing fails.
  Future<void> call(String taskId) => _repository.pauseDownload(taskId);
}
