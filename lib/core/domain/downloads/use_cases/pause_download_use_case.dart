...
class PauseDownloadUseCase {
  /// Creates a new PauseDownloadUseCase instance.
  PauseDownloadUseCase(this._repository);

  final DownloadsRepository _repository;

  /// Executes the pause download use case.
  ///
  /// The [downloadId] parameter is the unique identifier for the download.
  ///
  /// Throws [Exception] if pausing fails.
  Future<void> call(String downloadId) => _repository.pauseDownload(downloadId);
}
