...
/// Use case for removing a download.
class RemoveDownloadUseCase {
  /// Creates a new RemoveDownloadUseCase instance.
  RemoveDownloadUseCase(this._repository);

  final DownloadsRepository _repository;

  /// Executes the remove download use case.
  ///
  ...
  Future<void> call(String downloadId) =>
      _repository.removeDownload(downloadId);
}
