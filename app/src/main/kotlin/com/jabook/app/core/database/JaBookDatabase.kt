...
/**
 * Main Room database for JaBook application.
 * Contains all audiobook-related data including metadata, chapters, and bookmarks.
 */
@Database(
    entities = [
...
abstract class JaBookDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        @Volatile
        private var INSTANCE: JaBookDatabase? = null
