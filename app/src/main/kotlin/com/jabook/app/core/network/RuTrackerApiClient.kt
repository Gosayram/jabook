...
interface RuTrackerApiClient {
    ...
    suspend fun searchGuest(query: String, category: String? = null, page: Int = 1): Result<RuTrackerSearchResult>
...
class RuTrackerApiClientImpl @Inject constructor(
    ...
    override suspend fun searchGuest(query: String, category: String?, page: Int): Result<RuTrackerSearchResult> {
        return try {
    ...
    override suspend fun searchAuthenticated(query: String, sort: String, order: String, page: Int): Result<RuTrackerSearchResult> {
        return try {
