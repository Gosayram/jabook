...
/**
 * Implementation of AudiobookRepository using Room database.
 * Provides concrete data access operations for audiobooks.
 */
@Singleton
class AudiobookRepositoryImpl
    ...
    constructor(
        ...
        override suspend fun deleteChapter(id: String) {
            chapterDao.getChapterById(id)?.let { chapter ->
