 ...
 */
@Singleton
class RuTrackerErrorHandler @Inject constructor(
    ...
    private suspend fun updateRecentErrors() {
        val recent = errorReports.values
     ...
     */
    suspend fun getErrorReport(errorId: String): ErrorReport? {
    ...
    suspend fun clearResolvedErrors() {
        val resolvedIds = errorReports.values
    ...
    fun getErrorSummary(): Flow<Map<String, String>> {
        return _errorStatistics.map { stats ->
            mapOf(
