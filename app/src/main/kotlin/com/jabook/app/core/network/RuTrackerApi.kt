...
/** RuTracker API interface for audiobook discovery Based on IDEA.md architecture specification */
interface RuTrackerApi {
    ...
    @GET("forum/viewtopic.php") suspend fun getAudiobookDetails(@Query("t") topicId: String): Response<String>
...
data class Category(val id: String, val name: String, val parentId: String? = null, val subcategories: List<Category> = emptyList())
