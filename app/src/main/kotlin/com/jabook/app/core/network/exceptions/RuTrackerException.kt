 ...
 */
sealed class RuTrackerException(message: String, cause: Throwable? = null) : Exception(message, cause) {
     ...
     */
    class AllDomainsUnavailableException(message: String, cause: Throwable? = null) : 
        RuTrackerException(message, cause)

    /**
     * Circuit breaker is open (service temporarily blocked)
     */
    class CircuitBreakerOpenException(message: String, cause: Throwable? = null) : 
        RuTrackerException(message, cause)
     ...
     * Offline mode errors
     */
    class OfflineException(message: String, cause: Throwable? = null) : 
        RuTrackerException(message, cause)
     ...
     */
    class SearchUnavailableException(message: String, cause: Throwable? = null) : 
        RuTrackerException(message, cause)

    /**
     * Parsing timeout
     */
    class ParseTimeoutException(message: String, cause: Throwable? = null) : 
        RuTrackerException(message, cause)

    /**
     * Invalid response format
     */
    class InvalidResponseException(message: String, cause: Throwable? = null) : 
        RuTrackerException(message, cause)
     ...
     */
    companion object {
        fun fromErrorType(errorType: String, message: String, cause: Throwable? = null): RuTrackerException {
