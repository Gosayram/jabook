...
class TorrentRepositoryImpl @Inject constructor(private val torrentManager: TorrentManager, private val debugLogger: IDebugLogger) :
    ...
    override fun getTorrentStatus(torrentId: String): Flow<TorrentStatus> {
        return flowOf(TorrentStatus.DOWNLOADING)
    }
    ...
    override fun getStatistics(): Flow<Map<String, Long>> {
