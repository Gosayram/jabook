...
/** Room entity representing a chapter within an audiobook. Linked to AudiobookEntity via foreign key relationship. */
@Entity(
  tableName = "chapters",
  foreignKeys =
    [
...
data class ChapterEntity(
  ...
  @ColumnInfo(name = "audiobook_id") val audiobookId: String,
  @ColumnInfo(name = "chapter_number") val chapterNumber: Int,
  @ColumnInfo(name = "title") val title: String,
  @ColumnInfo(name = "file_path") val filePath: String,
  @ColumnInfo(name = "duration_ms") val durationMs: Long,
  @ColumnInfo(name = "start_position_ms") val startPositionMs: Long = 0,
  @ColumnInfo(name = "end_position_ms") val endPositionMs: Long = durationMs,
