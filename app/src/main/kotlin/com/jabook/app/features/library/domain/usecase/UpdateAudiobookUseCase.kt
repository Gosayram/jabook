...
/** Use case for updating audiobook properties. Handles various audiobook update operations. */
class UpdateAudiobookUseCase @Inject constructor(private val repository: AudiobookRepository) {
